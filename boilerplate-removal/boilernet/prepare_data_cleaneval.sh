...
./generate_cleaneval_html.py -i $RAW_DIR -o $HTML_OUT --val-ratio 0.1
...
./generate_cleaneval_extract.py -i $RAW_DIR -o $EXTRACT_DATA_OUT --word-map $PREPRO_OUT/words.json --tag-map $PREPRO_OUT/tags.json
