...
sbt "runMain bench.ExtractTraining ${RAW_DIR}/dev/en_original ${RAW_DIR}/dev/en_cleaned ${TRAIN_OUT}/dev"

echo -e "Generating training test data ...\n"
echo -e "Output directory: ${TRAIN_OUT}/test/ \n"
sbt "runMain bench.ExtractTraining ${RAW_DIR}/test/input ${RAW_DIR}/test/gold_std ${TRAIN_OUT}/test"
...
sbt "runMain bench.ExtractInferencing  ${RAW_DIR}/test/input ${RAW_DIR}/test/gold_std ${EXTRACT_DATA_OUT}"
