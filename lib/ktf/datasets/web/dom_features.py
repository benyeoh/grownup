...
from .dom_features_text import Text2VecFasttext, Text2VecUSE, TextSentenceTransformer
from .dom_features_font import FontSimple, FontCompStyles
from .dom_features_visual import VisualSimple, VisualCompStyles
...
class TagFeatures:
    ...
    def __init__(self,
        ...
        if text_model is None:
            assert "ft_model_path" in kwargs
            text_model = Text2VecFasttext(
                ft_model_path=kwargs["ft_model_path"],
                truncate_wordvec=kwargs["truncate_wordvec"] if "truncate_wordvec" in kwargs else None)
