...
$DIR/klassterfork/ktf/datasets/web/ki_04/evaluate_page_from_graph.py -i $INPUT_TFRECORD_DIR --model-config-path $DIR/klassterfork/runs/web/ki_04/ki_04.hjson --model-weights-path $INPUT_WEIGHTS_DIR